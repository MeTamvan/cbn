...
def tik():
    titik = [
     '.   ', '..  ', '... ']
    for o in titik:
        print '\r\x1b[1;91m[\xe2\x97\x8f] \x1b[1;92mYaNg SaBaR Yaa \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(1)
...
def login():
    ...
    try:
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] KoNeKsI iNtErNeT LaMbAt'
            keluar()
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCvNr1-LC2pQIS5ryREo26DA')
                time.sleep(2)
                menu()
...
def menu():
    ...
    try:
        ...
        try:
            ...
            print '\x1b[1;91m[!] KoNeKsI iNtErNeT LaMbAt'
            keluar()
